...
using Nop.Plugin.Payments.SendSpend.Validators;
using Nop.Services;
...
namespace Nop.Plugin.Payments.SendSpend.Controllers
{
    public class PaymentSendSpendController : BasePaymentController
    {
        ...
        public PaymentSendSpendController(IWorkContext workContext,
        ...
        public ActionResult Configure()
        {
            ...
            model.PreAuth = manualPaymentSettings.PreAuth;
            ...
            if (storeScope > 0)
            {
                ...
                model.PreAuth_OverrideForStore = _settingService.SettingExists(manualPaymentSettings, x => x.PreAuth, storeScope);
            }

            return View("~/Plugins/Payments.SendSpend/Views/Configure.cshtml", model);
        }
        ...
        public ActionResult Configure(ConfigurationModel model)
        {
            ...
            manualPaymentSettings.PreAuth = model.PreAuth;
            ...
            _settingService.SaveSettingOverridablePerStore(manualPaymentSettings, x => x.PreAuth, model.PreAuth_OverrideForStore, storeScope, false);
        ...
        public ActionResult PaymentInfo()
        {
            ...
            return View("~/Plugins/Payments.SendSpend/Views/PaymentInfo.cshtml", model);
        }
        ...
        public override IList<string> ValidatePaymentForm(FormCollection form)
        {
            ...
            if (!validationResult.IsValid)
                ...
                {
                    var oAuth = new Models.ApiAuthRequest { apiId = manualPaymentSettings.AppId, countryCode = model.Country , customer_fmm_UserNameOrMobileNo = model.PhoneNumber };
