...
namespace Nop.Plugin.Payments.SendSpend.Models
{
    ...
    public class PaymentInfoModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Plugins.Payments.SendSpend.Country")]
        public IList<SelectListItem> Countries { get; set; }

        [NopResourceDisplayName("Plugins.Payments.SendSpend.PhoneNumber")]
        [AllowHtml]
    ...
    public class ApiPaymentRequest
    {
        ...
        public bool merch_preAuth { get; set; }
        public string countryCode { get; set; }
    }
    ...
    public class PaymentOrderMechantUpdate
    {
        public string apiId { get; set; }
